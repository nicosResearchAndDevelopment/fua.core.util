...
const ts = require('@fua/core.ts');

const _secondsToMS = (value) => is.number(value) ? 1e3 * value : value;
const _msToSeconds = (value) => is.number(value) ? value / 1e3 : value;
...
exports.duration = (value, reference) => _msToSeconds(ts.duration(_secondsToMS(value), _secondsToMS(reference)));
